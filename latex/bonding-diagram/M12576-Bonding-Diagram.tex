...
\resizebox{\textwidth}{!}{
% Insert the tikzpicture from ezpdf.tex here
...
\noindent\texttt{Muse Semiconductor\\
M11719 \\
Quik-Pak 48-QFN-7x7, 0.500 mm pitch \\
Arrow points to the top of the design (North, in the direction of the increasing y coordinate)\\
0 degrees rotation
}
\end{document}
