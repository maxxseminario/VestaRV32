...
#define SPI_DL_32BIT         (2 << 2)   // 32-bit data length
#define SPI_DL_8BIT         (0 << 2)   // 8-bit data length
...
#define SYS_DCO0_ON_MASK        (0x80)  // Bit 7
#define SYS_DCO1_ON_MASK        (0x100)  // Bit 8
